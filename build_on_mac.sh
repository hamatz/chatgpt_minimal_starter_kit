...
flet build $@ --build-version $build_version -build-number $build_number --project $project_name --description $description --product $product_name --org $org_name --company $company_name --copyright $copyright
