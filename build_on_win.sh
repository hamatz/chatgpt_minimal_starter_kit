...
flet build $args --build-version $buildVersion --build-number $buildNumber --project $projectName --description $description --product $productName --org $orgName --company $companyName --copyright $copyright
